<?php
    ...
    if($check_cookie==true) {
        ...
        if($check_password==true) {        
            ...
            $mysql_myYells=mysql_query("SELECT * FROM `myYells`.`$myYells` order by myYells_id desc LIMIT 0,999");
            while(list($myYells_id, $myYells_user_id, $myYells_timestamp, $myYells_public, $myYells_type, $myYells_message, $myYells_comments) = mysql_fetch_row($mysql_myYells)) {
                ...
                print "<li id=my".$myYells_id.">User ".$myYells_user_id."(".$time."): ".$myYells_message." <a href='#' onclick=myyells_querry.Delete('my".$myYells_id."')>X</a></li>";
            }
        } else {
