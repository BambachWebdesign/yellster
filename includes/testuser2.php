...
$user_pw = "test";
    ...
    $user_month = "3";
    $user_year = "1988";
$user_firstname = "Monika";
$user_familyname = "Maurer";    
$user_birthday = mktime(0,0,1,$user_month,$user_day,$user_year);
$user_gender = "female";
$user_status = "1";
$user_status_with = "Daniel";
$user_lookingfor = "1";
$user_language = "deutsch";
$user_email = "M-oni.DariaG@gmx.de";
$user_phone = "09729 / 7117";  
$user_mobilphone = "xxxx / xxxxxxxx";
$user_adress = "Am Friedhof";
$user_adressnr = "14";
$user_city = "Grettstadt";
$user_citycode = "974xx";
...
$user_id = crc32("bambinet@t-online.de");
...
?>
<a href="testuser2.php?option=create">Testuser erstellen!</a><br /><br />
<a href="testuser2.php?option=delete">Testuser l&ouml;schen!</a>
